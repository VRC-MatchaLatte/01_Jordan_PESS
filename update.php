...
img {
  ...
  margin-right: auto;
	...
	if(isset($_POST["btnUpdate"])){
		...
		// last but not least, update incident table to completed (3) patrol car attended to it are FREE now
...
<br><br>
		<fieldset>	
<legend style="color: #FFFFFF; font-size: 18px;">Update Status</legend>
<?php
	if(!isset($_POST["btnSearch"])){
		?>
<!--  create a from to search for patrol car based on id -->
	<form name="form1" method="post" action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?> ">
		...
		<br>	
			<tr></tr>
		<tr>
			<td style="color: #FFFFFF; font-size: 20px;">Patrol Car ID :</td>
		  <td><input type="text" name="patrolCarId" id="patrolCarId" style="color: #FFFFFF; font-size: 20px;"></td>
			<td><input type="submit" name="btnSearch" id="btnSearch" value="Search"></td></tr></table>
	</form>
			<br>
			<br>
			<br>
	...
	?>
<br>
	<!-- display a from for operator to update status of patrol car -->
	<form name="form2" method="post" action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>">
		...
		<tr>
			...
			<td style= "color:#ffffff" ><?php echo $patrolCarId ?>
